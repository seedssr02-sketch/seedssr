...
export const PRODUCTS: Product[] = [
  ...
  */
  ...
  },
  {
    ...
    type: 'Indica-dominante',
    price: 110.0,
    image: PLACEHOLDER('Wedding Cake', '#b08968'),
  ...
  },
  {
    ...
    price: 135.0,
    image: PLACEHOLDER('Gorilla Glue #4', '#3d5a3d'),
  ...
  },
  {
    ...
    name: 'Amnesia Haze Feminizada',
    category: 'feminizadas',
    genetics: 'Cambodian x Haze x Afghani x Hawaiian',
    thc: '21%',
    cbd: '0,4%',
    flowering: '10-11 semanas',
    yield: '600-700 g/m²',
    type: 'Sativa-dominante',
    price: 115.0,
    image: PLACEHOLDER('Amnesia Haze', '#7c9c3a'),
    shortDescription: 'Clássica sativa cerebral.',
    description:
      'Amnesia Haze é uma sativa lendária com efeito altamente cerebral e criativo. Recomendada para cultivos indoor com paciência no flowering.',
    stock: 25,
  },
  {
    id: 'p6',
    slug: 'cbd-charlotte-angel',
    name: "Charlotte's Angel CBD",
    category: 'cbd',
    genetics: "Charlotte's Web x Dutch Hemp",
    thc: '<1%',
    cbd: '15%',
    flowering: '9 semanas',
    yield: '400-500 g/m²',
    type: 'CBD medicinal',
    price: 145.0,
    image: PLACEHOLDER('Charlotte CBD', '#2bb673'),
    shortDescription: 'Alta concentração de CBD, baixo THC.',
    description:
      "Charlotte's Angel oferece alívio sem efeito psicoativo significativo. Indicada para usuários que buscam os benefícios terapêuticos do canabidiol.",
    stock: 20,
  },
  {
    id: 'p7',
